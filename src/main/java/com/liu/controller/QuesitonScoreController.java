...
public class QuesitonScoreController {
    ...
    public String StuScoreMobile(HttpServletRequest request, Map<String, Object> map) {
        HttpSession session = request.getSession();
        Object user = session.getAttribute("user");
        int sno = ((User) user).getAccount();
        QuestionScore questionScore = questionScoreService.getQuestionScoreBySno(sno);
    ...
    public String TeaAddScore(HttpServletRequest request, @RequestParam("sno") int sno, @RequestParam("questionid") int questionid,
                              @RequestParam("earlyperformance") int earlyperformance, @RequestParam("midexam") int midexam,
                              @RequestParam("thesisanswer") int thesisanswer, @RequestParam("paper") int paper,
    ...
    @PostMapping(value = "/TeaAddScoreMobile")
    public String TeaAddScoreMobile(HttpServletRequest request, @RequestParam("sno") int sno, @RequestParam("questionid") int questionid,
                                    @RequestParam("earlyperformance") int earlyperformance, @RequestParam("midexam") int midexam,
                                    @RequestParam("thesisanswer") int thesisanswer, @RequestParam("paper") int paper,
                                    @RequestParam("extracredit") int extracredit) {
        //判断是否打过分
    ...
    public String ManageLookThroughGrade(HttpServletRequest request, Map<String, Object> map) {
    ...
    public String ManageScore(HttpServletRequest request, @RequestParam("sno") int sno, Map<String, Object> map) {
        HttpSession session = request.getSession();
    ...
    @PostMapping(value = "/ManageScore")
    public String ManageScore(HttpServletRequest request, @RequestParam("sno") int sno, @RequestParam("questionid") int questionid,
                              Map<String, Object> map, @RequestParam("earlyperformance") int earlyperformance,
                              @RequestParam("midexam") int midexam, @RequestParam("thesisanswer") int thesisanswer,
                              @RequestParam("paper") int paper, @RequestParam("extracredit") int extracredit) {
        QuestionScore questionScore = new QuestionScore();
        questionScore.setSno(sno);
        questionScore.setQuestionid(questionid);
        questionScore.setEarlyperformance(earlyperformance);
