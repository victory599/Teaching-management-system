...
public class UserControllerApi {
    ...
    public ResponseMessage changePassword(@RequestParam("newpass") String password, HttpServletRequest request) {
    ...
    public ResponseMessage fixpasswordBack(@RequestParam("account") Integer account, @RequestParam("newpass") String newpass) {
