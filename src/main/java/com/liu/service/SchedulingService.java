...
/**
 * 注意：未完成，修改了一下 tno sno 的数据类型 String -> Integer
 */
@Service
public class SchedulingService {
    ...
    public ResponseMessage getCourse(Integer cno, String year, String semester, String majorName, Integer grade) {
    ...
    public ResponseMessage addCourse(Integer cno, Integer tno, String year, String semester, String majorName, Integer grade,
                                     String status, String capacity1, String address, String time) {
    ...
    public ResponseMessage deleteCourse(Integer cno, String year, String semester, String majorName, Integer grade) {
        Integer semesterId = semesterDao.getSemesterId(year, semester);
        Integer majorId = majorDao.getMajorIdByMajorName(majorName);
    ...
    public ResponseMessage getCoursesByTnoAndTnameAndAddress(Integer tno, String tname, String address) {
        List<MobileSchedulingView> mobileSchedulingView = schedulingDao.getCoursesByTnoAndTnameAndAddress(tno, tname, address);
    ...
    public List<TeaCourseView> getCourseInfoByTno(int tno) {
        ...
        System.out.println("course: " + teaCourseViews);
