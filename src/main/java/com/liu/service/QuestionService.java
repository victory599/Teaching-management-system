...
public class QuestionService {
    ...
    /**
     * 学生根据论题号查询单个题目的全部信息(为了删除和确认学生等逻辑)
    ...
    /**
     * 老师根据论题号删除论题，注意：必须有该论题且未被选中才能删除
     * @param questionid 论题id
    ...
    /**
     * 老师确认学生和选题之间的连接，注意：必须有该论题且该论题未被选中，并且学生也没有选中其他论题
     * @param questionId 论题id
     * @param sno        学号
    ...
    private ResponseMessage setMessage(List<Question> questions) {
        ResponseMessage message = ResponseMessage.getMessage(questions != null && !questions.isEmpty(),
                ResponseMessage.SUCCESS, "Inquire Success !", ResponseMessage.EmptyDate, "No Information Found !");
    ...
    private ResponseMessage setMessageSingle(Question question) {
        ResponseMessage message = ResponseMessage.getMessage(question != null,
                ResponseMessage.SUCCESS, "Inquire Success !", ResponseMessage.EmptyDate, "No Information Found !");
    ...
    public ResponseMessage messageAddQuestion(Question question) {
        ...
        ResponseMessage message = ResponseMessage.getMessage(isAdded, ResponseMessage.SUCCESS, "Add Success！",
    ...
    public ResponseMessage messageDeleteQuestion(int questionid) {
        ...
        ResponseMessage message = ResponseMessage.getMessage(isDeleted, ResponseMessage.SUCCESS, "Delete Success!",
    ...
    public ResponseMessage messageSureQuestionStudent(int questionid, int sno) {
        ...
        ResponseMessage message = ResponseMessage.getMessage(isSured, ResponseMessage.SUCCESS, "Sure Success!",
