...
public class ResponseMessage {
    ...
    public static final Integer LoginOutOfTime = 302;
     ...
     * @return
     */
    public static ResponseMessage getMessage(Boolean condition, Integer successCode, String successMsg, Integer otherCode, String otherMsg) {
